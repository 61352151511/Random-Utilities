package com.sixonethree.randomutilities.common.entity;
...
public class EntityCreepySpider extends EntityMob {
	public EntityCreepySpider(World world) {
		super(world);
		this.setSize(1.4F, 0.9F);
		this.tasks.addTask(1, new EntityAISwimming(this));
		this.tasks.addTask(2, this.aiAvoidExplodingCreepers);
		this.tasks.addTask(3, new EntityAILeapAtTarget(this, 0.4F));
		this.tasks.addTask(4, new EntityCreepySpider.AICreepySpiderAttack(EntityPlayer.class));
		this.tasks.addTask(4, new EntityCreepySpider.AICreepySpiderAttack(EntityIronGolem.class));
		this.tasks.addTask(5, new EntityAIWander(this, 0.8D));
		this.tasks.addTask(6, new EntityAIWatchClosest(this, EntityPlayer.class, 8.0F));
		this.tasks.addTask(6, new EntityAILookIdle(this));
		this.targetTasks.addTask(1, new EntityAIHurtByTarget(this, false, new Class[0]));
		this.targetTasks.addTask(2, new EntityCreepySpider.AICreepySpiderTarget(EntityPlayer.class));
		this.targetTasks.addTask(3, new EntityCreepySpider.AICreepySpiderTarget(EntityIronGolem.class));
	}
	
	@Override protected PathNavigate getNewNavigator(World worldIn) {
	...
	@Override protected void dropFewItems(boolean extra, int param2) {
		super.dropFewItems(extra, param2);
		
		if (extra && (this.rand.nextInt(3) == 0 || this.rand.nextInt(1 + param2) > 0)) {
	...
	@Override public boolean isPotionApplicable(PotionEffect effect) {
	...
	public class AICreepySpiderAttack extends EntityAIAttackOnCollide {
		@SuppressWarnings("rawtypes") public AICreepySpiderAttack(Class targetClass) {
			super(EntityCreepySpider.this, targetClass, 1.0D, true);
		}
		...
		@Override protected double func_179512_a(EntityLivingBase attackTarget) {
			return (double) (4.0F + attackTarget.width);
		}
	}
	
	public class AICreepySpiderTarget extends EntityAINearestAttackableTarget {
		@SuppressWarnings("rawtypes") public AICreepySpiderTarget(Class classTarget) {
			super(EntityCreepySpider.this, classTarget, true);
		}
